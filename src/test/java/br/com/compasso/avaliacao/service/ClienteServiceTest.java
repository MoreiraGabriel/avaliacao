...
public class ClienteServiceTest {
	...
	public void setup() {
		...
		cliente = new Cliente(1L, "José", "M", LocalDateTime.now(), 20L, cidade);
	...
	public void ObterPorIdTest(){
		...
		when(repository.findById(Mockito.anyLong())).thenReturn(Optional.of(cliente));
		
		Optional<ClienteDto> result = service.obterPorId(1L);
	...
	public void atualizaNomeTest(){
		...
		ClienteDto result = service.atualizaNome(1L, nome);
